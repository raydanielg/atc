      ...
      <div className="grid gap-6">
        <div className="rounded-3xl border border-slate-200 bg-white p-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-2 text-lg font-semibold text-slate-900">Results summary</p>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-3">
            <Stat label="Overall" value={`${overallPercent}%`} />
            <Stat label="Grade" value={overallGrade} />
            <Stat label="Modules" value={`${selected?.rows.length ?? 0}`} />
          </div>
        </div>
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6">
          <div className="flex items-center justify-between gap-4">
            <div>
              <p className="text-xs font-semibold tracking-widest text-slate-500">MARKS</p>
